    ...
    def _init_schema(self):
        ...
        if row is None:
            ...
            if current_version < 11:
                ...
                # strategies. Tables and indexes are created by SCHEMA_SQL; this
                # version gate remains as a durable marker for older PR databases.
                pass
            if current_version < 12:
                # v12: re-index FTS5 tables to cover tool_name + tool_calls and
                # switch from external-content to inline mode. Existing DBs from
                # either side of the v11 merge conflict may already report version
                # 11, so this merged migration gets a fresh version number.
                for _trig in (
                    "messages_fts_insert",
                    "messages_fts_delete",
                    "messages_fts_update",
